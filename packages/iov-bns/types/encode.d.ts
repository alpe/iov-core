...
export declare function buildMsg(tx: UnsignedTransaction): codecImpl.grafain.ITx;
export declare function buildUnsignedTx(tx: UnsignedTransaction): codecImpl.grafain.ITx;
export declare function buildSignedTx(tx: SignedTransaction): codecImpl.grafain.ITx;
