...
function pendingWithoutBnsd(): void {
  if (!process.env.BNSD_ENABLED) {
    pending("Set BNSD_ENABLED to enable grafaind-based tests");
  }
}
...
describe("BnsConnection", () => {
  ...
  const grafaindTendermintUrl = "wss://rpc-chilinet.grafain.net:443";
  const grafaindTendermintHttpUrl = "ws://rpc-chilinet.grafain.net:80";
